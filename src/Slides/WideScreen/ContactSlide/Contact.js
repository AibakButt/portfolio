  ...
  render() {
    ...
    return (
      <Container>
        ...
        <SocialMediaIcons>
          <SocialLogo imgURL={linkedInImg} alternate="Linkedin" redirectURL="https://www.linkedin.com/in/aibak-shahzad-66145b199/" />
          {/* <SocialLogo imgURL={twitterImg} alternate="Twitter" redirectURL="https://twitter.com/aibak" /> */}
          <SocialLogo imgURL={githubImg} alternate="Github" redirectURL="https://github.com/AibakButt" />
          <SocialLogo imgURL={mailImg} alternate="Mail" redirectURL="mailto:aibak.butt113@gmail.com" />
          <SocialLogo imgURL={instaImg} alternate="Instagram" redirectURL="https://instagram.com/aibakbutt?igshid=MzNlNGNkZWQ4Mg==" />
          {/* <SocialLogo imgURL={dribbbleImg} alternate="Dribbble" redirectURL="https://dribbble.com/aibak" /> */}
        </SocialMediaIcons>
      </Container>
    );
  }

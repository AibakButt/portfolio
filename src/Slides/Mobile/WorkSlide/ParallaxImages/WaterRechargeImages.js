...
class FastRetailingImages extends Component {
  render() {
    ...
    return (
      <React.Fragment>
        <FastRetailingPhonePLST src={mobileImg} scroll={scrollPercent} alt="fastRetailingPLST" />
        <FastRetailingPhoneUQ src={tabImg} scroll={scrollPercent} alt="fastRetailingGU2" />
      </React.Fragment>
    );
  }
}
